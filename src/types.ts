...
export interface ProviderMultiAgentResearchCapabilityResult { capability: 'multi-agent-research'; completeness: 'complete' | 'partial' | 'empty'; answer?: string; results: readonly GmaResult[]; trace: GmaTrace; model: string; reasoning_effort: GmaEffort; api_mode: 'chat_completions' | 'messages'; expected_agent_count: 4 | 16; backend_trace_observable: false; evidence_linkage: 'model_declared_url_matched'; semantic_verification: false }
